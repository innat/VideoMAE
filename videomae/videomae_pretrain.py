...
class TFPretrainVisionTransformer(keras.Model):
    def __init__(
        ...
        **kwargs
        ...
        self.encoder = TFPretrainVisionTransformerEncoder(
            ...
            name="TFPretrainVisionTransformerEncoder",
        )
    ...
    def call(self, x, mask):
        ...
        pos_emd_mask = tf.reshape(tf.boolean_mask(expand_pos_embed, mask), [B, -1, C])
        ...
        x_full = tf.concat([x_vis + pos_emd_vis, mask_token + pos_emd_mask], axis=1)
